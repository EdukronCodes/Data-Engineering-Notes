...
Inventory pipeline L2 support with GDPR-aware incident handling.

**Manasa vs Pavani-03:** Stricter GDPR retail PII runbooks for inventory data.
...
| Pipeline | Purpose |
|----------|---------|
| `PL_MAN_Support_Health` | See ADF orchestration below |
| `PL_MAN_Incident_Response` | See ADF orchestration below |
...
```
/Manasa/Support/NB_Incident_Audit
```
