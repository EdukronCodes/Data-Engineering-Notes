...
> **Reference:** Adapted from [https://github.com/Analytics6/Azure-Data-Engineering-Notes](https://github.com/Analytics6/Azure-Data-Engineering-Notes) — `01-Supply-Chain-Analytics-Platform.md, 05-Retail-Store-Performance-Analytics-Platform.md`

## Project Overview and Business Context

Batch replenishment models using WMS/ERP feeds; nightly ADF + Databricks batch.

**Karthik focus:** Replenishment optimization batch (not real-time streaming).
...
### Gold
- `gold.replenishment_recommendation`
- `gold.store_performance_daily`
...
| Pipeline | Purpose |
|----------|---------|
| `PL_KAR_Replenish_Bronze` | See ADF orchestration below |
| `PL_KAR_Replenish_Gold` | See ADF orchestration below |
...
```
/Karthik/NB_Replenishment_Model
NB_Store_Performance
```
