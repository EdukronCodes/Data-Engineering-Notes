...
ERP/POS migration with DataOps validation gates before Gold promotion.

**Roja focus:** DataOps validation gates (Great Expectations) at each medallion hop.
...
| Pipeline | Purpose |
|----------|---------|
| `PL_ROJA_MIG_Bronze` | See ADF orchestration below |
| `PL_ROJA_MIG_Validate_Gold` | See ADF orchestration below |
| `PL_ROJA_MIG_Cutover` | See ADF orchestration below |
