...
> **Reference:** Adapted from [https://github.com/Analytics6/Azure-Data-Engineering-Notes](https://github.com/Analytics6/Azure-Data-Engineering-Notes) — `06-Retail-Customer-Loyalty-Rewards-Data-Pipeline.md, 10-Retail-Customer-Analytics-Platform.md`

## Project Overview and Business Context

Real-time sales and customer 360 streaming for loyalty and personalization.

**Roja focus:** Sales/customer 360 streaming vs Mugalin demand forecasting.
...
| Pipeline | Purpose |
|----------|---------|
| `PL_ROJA_Stream_Health` | See ADF orchestration below |
| `PL_ROJA_Gold_Customer_360` | See ADF orchestration below |
...
```
/Roja/NB_Stream_Sales
NB_Gold_Customer_360
```
