...
> **Reference:** Adapted from [https://github.com/Analytics6/Azure-Data-Engineering-Notes](https://github.com/Analytics6/Azure-Data-Engineering-Notes) — `09-Enterprise-Data-Governance-Observability-Platform.md`

## Project Overview and Business Context

DataOps SLA monitoring, Purview lineage, and governance-aligned support.

**Roja focus:** SLA dashboards + Purview lineage for retail DataOps.
...
| Pipeline | Purpose |
|----------|---------|
| `PL_ROJA_SLA_Monitor` | See ADF orchestration below |
| `PL_ROJA_Lineage_Scan` | See ADF orchestration below |
