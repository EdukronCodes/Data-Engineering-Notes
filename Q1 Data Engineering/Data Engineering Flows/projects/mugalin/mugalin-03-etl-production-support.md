...
Production support with automated remediation for common ADF/Databricks failures.

**Mugalin focus:** Incident resolution playbooks and Logic App auto-retry chains.
...
| Pipeline | Purpose |
|----------|---------|
| `PL_MUG_Support_Health` | See ADF orchestration below |
| `PL_MUG_Auto_Remediate` | See ADF orchestration below |
...
```
/Mugalin/Support/NB_Incident_Log
```
