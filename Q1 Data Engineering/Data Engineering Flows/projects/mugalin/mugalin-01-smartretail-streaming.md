...
(spark.readStream.format("cloudFiles")
 ...
 .option("cloudFiles.schemaLocation", "abfss://bronze@stretail{env}/_schemas/sales_txn")
 .load("abfss://landing@stretail{env}/sales_txn/")
 .withColumn("_ingest_ts", current_timestamp())
 .writeStream
 .option("checkpointLocation", "abfss://silver@stretail{env}/_checkpoints/sales_txn")
 .trigger(processingTime="5 minutes")
 .toTable("retail_bronze.sales_txn"))
```
...
> **Reference:** Adapted from [https://github.com/Analytics6/Azure-Data-Engineering-Notes](https://github.com/Analytics6/Azure-Data-Engineering-Notes) — `04-Retail-E-commerce-Data-Platform.md, Multi_Channel_Retail_Data_Platform.md`

## Project Overview and Business Context

Micro-batch demand signals from e-commerce + POS for inventory allocation; Event Hubs + Structured Streaming.

**Mugalin focus:** Demand forecasting micro-batch (5-min) vs Pavani supply-chain SLA alerts.
...
### Gold
- `gold.demand_signal_5min`
- `gold.inventory_allocation`
...
| Pipeline | Purpose |
|----------|---------|
| `PL_MUG_Stream_Health` | See ADF orchestration below |
| `PL_MUG_Bronze_Orders` | See ADF orchestration below |
| `PL_MUG_Gold_Demand` | See ADF orchestration below |
...
```
/Mugalin/NB_Stream_Orders
NB_Gold_Demand_Forecast_Input
```
