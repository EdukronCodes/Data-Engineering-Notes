...
# MAGIC %md
# MAGIC # Bronze â€” POS Transactions
# MAGIC Raw ingest from ADLS landing to Delta bronze table.
...
source_path = f"{landing_path(base, 'pos_transactions')}"
target_path = bronze_path(base, "pos_transactions")
